                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="radio" value="Mr_Burger" name="origin" class="form-radio-input" required>
...
if (isset($_GET['delete'])) {
    ...
    if ($store == 'chillox') {
        $sql = "DELETE FROM chillox WHERE id={$id}";
        ...
        $sql = "DELETE FROM Mr_Burger WHERE id={$id}";
        $delete_data = mysqli_query($conn, $sql);
        if ($delete_data) {
        ...
        $sql = "DELETE FROM takeout WHERE id={$id}";
        $delete_data = mysqli_query($conn, $sql);
        if ($delete_data) {
