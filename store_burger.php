...
<body>
    ...
    <div class="container p-3" style="margin-top: 80px;">
        <h2 style="text-align: center; font-family:Fira Code; background-color:lightblue">Mr. Burger</h2>
        <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="card box-shadow" style="width: 17rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="compare_index.php?store=Mr_Burger&&food_name=<?php echo $row['food_name']; ?>" class="btn btn-warning">Compare</a>
                                <a href="single_product.php?store=Mr_Burger&&id=<?php echo $row['id']; ?>" class="btn btn-warning">৳ <?php echo $row['price']; ?></a>
                            </div>
                        </div>
                    </div>
            <?php
